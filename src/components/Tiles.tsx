const Tiles = () => (
  <>
    <ul className="grid gap-y-10 m-4">
      <li className="flex flex-col p-8 bg-white border border-gray-300 rounded">
        <a href="/WAI/ARIA/apg/patterns/accordion/" className="text-wai-green hover:underline focus:outline-offset-8 focus:outline-blue-700 visited:text-wai-green">
          <h2 className="flex items-start mb-4">
