            ...
            <li key={`post-${id}`}>
              <Link className="group relative flex rounded-2xl p-2 md:active:scale-98 items-center justify-between" href={`/posts/${slug}`}>
                <div>
                    ...
                    <p className="my-0 dark:text-gray-350 hidden min-h-[26px] text-gray-500 transition-colors group-hover:text-gray-900 dark:group-hover:text-gray-200 sm:block">Where creators and brands meet</p>
                </div>
